...
(let (ref ref-file ref-file-path)
  (setq ref-file (ido-completing-read "Open reference:" files))
  (setq ref (assq ref-file database))
  (setq ref-file-path (cdr ref))
  (call-process pdf-viewer nil 0 nil ref-file-path))
